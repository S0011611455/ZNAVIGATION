		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comwakefernznavigation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comwakefernznavigation-display": {
								"semanticObject": "comwakefernznavigation",
								"action": "display",
								"description": "Navigation Demos  Description",
								"title": "Navigation Demo title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.wakefern.znavigation",
									"url": sap.ui.require.toUrl("com/wakefern/znavigation")
								}
							}
						}
					}
